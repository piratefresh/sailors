...
<section class="gallery">
    <div class="slider">
        <div class="slide"><img src="<?php the_field('slickImg1'); ?>" alt="" srcset=""></div>
        <div class="slide"><img src="<?php the_field('slickImg2'); ?>" alt="" srcset=""></div>
        <div class="slide"><img src="<?php the_field('slickImg3'); ?>" alt="" srcset=""></div>
        <div class="slide"><img src="<?php the_field('slickImg4'); ?>" alt="" srcset=""></div>
        <div class="slide"><img src="<?php the_field('slickImg5'); ?>" alt="" srcset=""></div>
        <div class="slide"><img src="<?php the_field('slickImg6'); ?>" alt="" srcset=""></div>
    </div>
</section>
